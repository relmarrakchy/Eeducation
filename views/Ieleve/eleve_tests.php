<?php require "../../phpFiles/Eleve/eleTest.php" ?>
...
<head>
    ...
    <link rel="stylesheet" href="./css/eleve_tests.css">
    
    <title>eEducation</title>
</head>
<body oncontextmenu="return false;" onmousedown="return false;" onselect="return false">
    <div id="king">
        <div class="prince1">
            <div class="userDiv">
                <ul>
            ...
            <div class="sidebarDiv">
                <div class="sidebar">
                    ...
                    <nav>
                        ...
                        <div class="navList active"><span><i class="fa-solid fa-calendar-days navIcon"></i><a href="./eleve_tests.php">Tests</a></span></div>
